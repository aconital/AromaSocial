...
module.exports=function(app,Parse) {
    ...
    app.get('/project/:objectId', function (req, res, next) {
    ...
    app.post('/project/:objectId/update',function(req,res,next){
        var query = new Parse.Query("Project");
        query.get(req.params.objectId,{
            success: function(result) {
    ...
    app.post('/project/:objectId/picture',function(req,res,next){
        var query = new Parse.Query("Project");
        query.get(req.params.objectId,{
            success: function(result) {
