                    ...
                    if(req.body.institution.objectId===null)
                    {
                        ...
                        query.each(function(result) {
                            ...
                            org.save(null).then(function (response)
                            {
                                ...
                                education.set("orgId", {__type: "Pointer", className: "Organization", objectId: response.id});
                                education.save(null, {
                                    success: function (obj) {
                                        result.add("educations", {__type: "Pointer", className: "Education", objectId: obj.id});
                    ...
                    if(req.body.company.objectId === null)
                    {
                        ...
                        query.each(function(result) {
                            ...
                            org.save(null).then(function (response)
                            {
                                ...
                                workExperience.set("orgId", {__type: "Pointer", className: "Organization", objectId: response.id});
