	...
	render: function() {
		...
		<div>
			<form className="form-horizontal">
                ...
                <Input type="text" label="Title:" labelClassName="col-xs-2" wrapperClassName="col-xs-10" onChange={this.props.title} />
                <Input type="text" label="Collaborators:" labelClassName="col-xs-2" wrapperClassName="col-xs-10" onChange={this.props.collaborators} />
                ...
                <Input type="textarea" label="Description:" labelClassName="col-xs-2" wrapperClassName="col-xs-10" onChange={this.props.description} />
                <Input type="text" label="License:" labelClassName="col-xs-2" wrapperClassName="col-xs-10" onChange={this.props.license} />
                <Input type="text" label="Link to publication:" labelClassName="col-xs-2" wrapperClassName="col-xs-10" onChange={this.props.pubLink} />
                <Input type="text" label="Keywords:" labelClassName="col-xs-2" wrapperClassName="col-xs-10" placeholder="Type in comma separated tags" onChange={this.props.keywords} />
                <Input type="text" label="URL:" labelClassName="col-xs-2" wrapperClassName="col-xs-10" placeholder="Link to patent" onChange={this.props.url} />
